// src/app/index.tsx
// Ecrã inicial — tela "Hoje" (Etapa 1.6).
// Mostra tarefas com dueDate <= hoje + atrasadas (useTodayTasks).
// Botão "+" no header abre o modal Quick Add.
      ...
      <View className="flex-1">
        <View className="px-5 pt-2 pb-3 flex-row items-center justify-between">
          ...
          <Pressable
            ...
            className="w-12 h-12 rounded-full bg-primary items-center justify-center active:opacity-80 shadow-lg"
